var ws = new WebSocket(location.href.replace('http', 'ws').replace('live', 'ws').replace('6543', '6544'));
console.log('ws://' + location.host + '/ws');
console.log("^");
console.log(location.href.replace('http', 'ws').replace('live', 'ws').replace('6543', '6544'));
